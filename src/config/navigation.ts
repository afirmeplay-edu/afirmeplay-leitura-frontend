...
export const DASHBOARD_FEATURE_CARDS = [
  {
    ...
    description: "Aplicacao individual com correcao automatica por IA: listas de palavras, pseudopalavras e leitura de texto narrativo.",
    accent: "emerald",
  },
  {
    href: "/app/configuracao-avaliacao",
    label: "Configurar Avaliacao",
    description: "Cadastre listas de palavras, textos narrativos e perguntas de compreensao personalizadas.",
    accent: "amber",
  },
  {
    href: "/app/avaliacao-leitura-guiada",
    label: "Avaliacao de Leitura Guiada",
    description: "Fluxo livre de avaliacao: selecione um aluno e um texto para iniciar uma sessao de leitura guiada.",
    accent: "blue",
  },
  {
    href: "/app/relatorios?aba=ica",
    label: "Relatorios ICA",
    description: "Graficos, tabelas e parecer tecnico-pedagogico com base no Indice Crianca Alfabetizada.",
    accent: "green",
  },
] as const;
